...
class ProcessosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create processo" do
    assert_difference("Processo.count") do
      post processos_url, params: { processo: { descricao: @processo.descricao, destino: @processo.destino, id: @processo.id, origem: @processo.origem } }
    end
  ...
  test "should update processo" do
    patch processo_url(@processo), params: { processo: { descricao: @processo.descricao, destino: @processo.destino, id: @processo.id, origem: @processo.origem } }
